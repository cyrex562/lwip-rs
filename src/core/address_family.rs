...
pub const AF_LOCAL: u32 = 1;     /* POSIX name for pub const AF_UNIX: u32	*/
...
pub const AF_NETLINK: u32 = 16;    /* Alias to emulate 4.4BSD */
...
pub const AF_SMC: u32 = 43;        /* smc sockets: reserve number for
                         ...
                         * reuses pub const AF_INET: u32 address family
                         */
pub const AF_XDP: u32 = 44; /* XDP sockets			*/
pub const AF_MCTP: u32 = 45; /* Management component
                  * transport protocol
                  */

pub const AF_MAX: u32 = 46; /* For now.. */
