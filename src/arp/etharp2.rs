...
use crate::arp::defs::{ARP_AGE_REREQUEST_USED_BROADCAST, ARP_AGE_REREQUEST_USED_UNICAST, ETHARP_FLAG_FIND_ONLY, ETHARP_FLAG_STATIC_ENTRY, ETHARP_FLAG_TRY_HARD};
use crate::arp::defs::etharp_q_entry;
use crate::arp::etharp_h::{etharp_hdr, IPADDR_WORDALIGNED_COPY_FROM_ip4_addr, IPADDR_WORDALIGNED_COPY_TO_ip4_addr, SIZEOF_ETHARP_HDR};
use crate::arp::etharp_h::etharp_opcode::{ARP_REPLY, ARP_REQUEST};
use crate::autoip::autoip2::autoip_arp_reply;
use crate::core::def_h::PP_HTONS;
use crate::core::err_h::{ERR_ARG, ERR_MEM, ERR_OK, ERR_RTE, ERR_VAL, LwipError};
use crate::core::iana_h::lwip_iana_hwtype::LWIP_IANA_HWTYPE_ETHERNET;
use crate::defines::LwipAddr;
use crate::dhcp::dhcp2::dhcp_arp_reply;
use crate::ethernet::ethernet_h::{ETH_HWADDR_LEN, LL_IP4_MULTICAST_ADDR_0, LL_IP4_MULTICAST_ADDR_1, LL_IP4_MULTICAST_ADDR_2};
use crate::ip::ip42::ip4_route;
use crate::ip::ip4_addr_h::{ip4_addr, ip4_addr2, ip4_addr3, ip4_addr4, ip4_addr_cmp, ip4_addr_copy, ip4_addr_isany, ip4_addr_isany_val, ip4_addr_islinklocal, ip4_addr_ismulticast, ip4_addr_netcmp, ip4_addr_set_zero};
...
pub fn etharp_set_addrhint(netif: NetIfc, addrhint: &mut Vec<u8>) {
 ...
 */
pub fn free_etharp_q(q: &mut etharp_q_entry) {
    let r: &mut etharp_q_entry;
...
pub fn etharp_free_entry(i: i32) {
 ...
 * @param flags See @ref EtharpState
...
pub fn etharp_input(p: &mut PacketBuffer, netif: &mut NetIfc) {
    ...
    etharp_update_arp_entry(netif, &sipaddr, &(hdr.shwaddr), a);
...
pub fn etharp_query(netif: &mut NetIfc, ipaddr: &mut ip4_addr, q: &mut PacketBuffer) {
    ...
    if (arp_table[i].state >= ETHARP_STATE_STABLE) {
        ...
        if (p != None) {
            ...
            let new_entry: &mut etharp_q_entry;
