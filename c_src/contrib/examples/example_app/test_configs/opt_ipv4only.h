...
pub const LWIP_DHCP_CHECK_LINK_UP: u32 = 0; #define LWIP_DHCP_BOOTP_FILE            0
pub const LWIP_DHCP_GET_NTP_SRV: u32 = 0; #define LWIP_DHCP_MAX_NTP_SERVERS       1
...
pub const LWIP_NETCONN: u32 = 1; #define LWIP_TCPIP_TIMEOUT              0
pub const LWIP_NETCONN_SEM_PER_THREAD: u32 = 0; #define LWIP_NETCONN_FULLDUPLEX         0
pub const LWIP_SOCKET: u32 = 1; #define LWIP_COMPAT_SOCKETS             1 /* 0..2 */
...
pub const LWIP_CHECKSUM_ON_COPY: u32 = 0; #define LWIP_IPV6                       0
